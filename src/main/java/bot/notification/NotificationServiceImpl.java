...
public class NotificationServiceImpl implements NotificationService {
    ...
    private IntroductionEvent getIntroductionEvent(GameInfo gameInfo) {
        ...
        return new IntroductionEvent(players, gameInfo.getRoundNumber());
    }
    ...
    private VoteEvent getVoteEvent(GameInfo gameInfo) {
        VoteEvent event = new VoteEvent(gameInfo.getRoundNumber());
    ...
    private MissionEvent getMissionEvent(GameInfo gameInfo) {
        ...
        MissionEvent event = new MissionEvent(gameInfo.getRoundNumber());
    ...
    private TeamChoosingEvent getTeamChoosingEvent(GameInfo gameInfo) {
        TeamChoosingEvent event = new TeamChoosingEvent(gameInfo.getRoundNumber());
